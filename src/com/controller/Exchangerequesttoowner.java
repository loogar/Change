...
/**
 * Servlet implementation class Exchangerequesttoowner
 */
@WebServlet("/Exchangerequesttoowner")
public class Exchangerequesttoowner extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Exchangerequesttoowner() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		exchangerequestownerBean requesttoowner = new exchangerequestownerBean();
		requesttoowner.setBookingid(bookingid);
      ...
      String sql = "select * from requestforexchange where Requestedto = '"+ userid +"' and bookingid =? ";
      	
       ExhangeDAO exchangedao = new ExhangeDAO();
	   ResultSet rs = exchangedao.detailstoowner(requesttoowner,sql);
