...
/**
 * Servlet implementation class PendingRequestids
 */
@WebServlet("/PendingRequestids")
public class PendingRequestids extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PendingRequestids() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      String sql = "select * from requestforexchange where requestedFrom = '"+ userid +"'";
      	
      ExhangeDAO exchangedao = new ExhangeDAO();
	   ResultSet rs = exchangedao.Pendingrequestdetails(sql);
