...
<link rel="stylesheet" href="style.css">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    ...
    <a href="how.html"> <button type="button" class="btn btn-outline-info" style='margin-right:16px'> How it works?</button></a>
     ...
     <a hidden href=""><button type="button" class="btn btn-outline-success">Login as ${fname}</button></a>
      
      <a href="UserRegistration.jsp"> <button type="button" class="btn btn-outline-danger"style='margin-right:16px'>Signup</button></a>
